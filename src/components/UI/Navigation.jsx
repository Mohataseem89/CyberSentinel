...
import { BarChart3, BookOpen, FileSearch, Flag, Menu, QrCode, Search, Shield, Upload, X } from 'lucide-react';
...
export default function Navigation() {
  ...
  const navItems = [
    ...
    ...(currentUser ? [{ path: '/bulk', label: 'Bulk Scan', icon: Upload }, { path: '/file-scan', label: 'File Analysis', icon: FileSearch }] : []),
